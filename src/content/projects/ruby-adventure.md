...
홍익대학교 게임소프트웨어전공 졸업작품으로, 기획부터 구현까지 1인 개발한 3D 액션 RPG입니다. 2019 졸업전시 우수상을 수상했고, 졸업생 대표 4인 중 1인으로 재학생 대상 발표를 진행했습니다.
...
`PlayerController`의 5가지 핵심 상태를 이중 변수(state / nextState) 기반의 커스텀 FSM으로 직접 설계해, 매 프레임 조건 검사와 상태 전이가 명확하게 이루어지도록 구조화했습니다.
...
2019 홍익대학교 게임학부 졸업작품전시에서 우수상을 수상했습니다. 졸업생 대표 4인 중 1인으로 선정되어 재학생 대상 발표를 맡았습니다.
