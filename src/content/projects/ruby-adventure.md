...
홍익대학교 게임소프트웨어전공 졸업작품으로, 기획부터 구현, 레벨디자인까지 3개월간 1인 개발한 3D 액션 RPG입니다. 처음부터 끝까지 혼자 완성한 첫 게임입니다. 데모가 아니라 끝까지 플레이되는 게임을 만드는 것을 목표로 잡았습니다.
...
조작감에 공을 들였습니다. 콤보와 스킬의 타이밍을 애니메이션과 맞추는 작업을 반복하며 다듬었습니다.
