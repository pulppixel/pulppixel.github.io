...
export const PLATFORMS: Platform[] = [
  // ── 스폰 섬 ──
  { x: 0, z: 0, w: 12, d: 10, h: 0.5 },

  // ── Zone 0: The Nether (2025-2026) ──
  { x: 0, z: -18, w: 16, d: 12, h: 1.0 },

  // ── Zone 1: Treasure Isle (2023) — 높은 절벽 ──
  { x: 28, z: -40, w: 16, d: 12, h: 2.5 },

  // ── Zone 2: Beacon Peak (2026) — 중간 메사 ──
  { x: -28, z: -40, w: 16, d: 12, h: 2.0 },

  // ── Zone 3: Overworld (2019-2022) — 가장 높은 언덕 ──
  { x: 0, z: -58, w: 16, d: 12, h: 3.2 },

  // ═══ 스폰 → Zone 0 (넓은 연결 다리) ═══
  { x: 0, z: -5, w: 6, d: 4, h: 0.55 },
  { x: 0, z: -9, w: 6, d: 4, h: 0.65 },
  { x: 0, z: -13, w: 5, d: 3, h: 0.80 },

  // ═══ Zone 0 → Zone 1 (오른쪽 상승 — 촘촘) ═══
  { x: 5, z: -22, w: 5, d: 4, h: 1.05 },
  { x: 10, z: -25, w: 4, d: 4, h: 1.2 },
  { x: 15, z: -28, w: 4, d: 4, h: 1.4 },
  { x: 19, z: -31, w: 4, d: 4, h: 1.6 },
  { x: 23, z: -34, w: 4, d: 4, h: 1.8 },
  { x: 26, z: -37, w: 4, d: 3, h: 2.1 },

  // ═══ Zone 0 → Zone 2 (왼쪽 상승 — 촘촘) ═══
  { x: -5, z: -22, w: 5, d: 4, h: 1.05 },
  { x: -10, z: -25, w: 4, d: 4, h: 1.2 },
  { x: -15, z: -28, w: 4, d: 4, h: 1.35 },
  { x: -19, z: -31, w: 4, d: 4, h: 1.5 },
  { x: -23, z: -34, w: 4, d: 4, h: 1.65 },
  { x: -26, z: -37, w: 4, d: 3, h: 1.85 },

  // ═══ Zone 0 → Zone 3 (중앙 상승 — 메인 루트) ═══
  { x: 0, z: -26, w: 5, d: 4, h: 1.1 },
  { x: 1, z: -30, w: 4, d: 4, h: 1.4 },
  { x: -1, z: -34, w: 4, d: 4, h: 1.7 },
  { x: 0, z: -38, w: 4, d: 4, h: 2.0 },
  { x: 1, z: -42, w: 4, d: 4, h: 2.3 },
  { x: 0, z: -46, w: 5, d: 4, h: 2.5 },
  { x: 0, z: -50, w: 5, d: 4, h: 2.8 },
  { x: 0, z: -54, w: 5, d: 3, h: 3.0 },

  // ═══ Zone 1 → Zone 3 (오른쪽 경유) ═══
  { x: 22, z: -43, w: 4, d: 4, h: 2.5 },
  { x: 17, z: -47, w: 4, d: 4, h: 2.7 },
  { x: 12, z: -51, w: 4, d: 4, h: 2.85 },
  { x: 7, z: -55, w: 4, d: 4, h: 3.0 },

  // ═══ Zone 2 → Zone 3 (왼쪽 경유) ═══
  { x: -22, z: -43, w: 4, d: 4, h: 2.1 },
  { x: -17, z: -47, w: 4, d: 4, h: 2.4 },
  { x: -12, z: -51, w: 4, d: 4, h: 2.7 },
  { x: -7, z: -55, w: 4, d: 4, h: 2.95 },

  // ═══ 스폰 섬 사이드 장식 플랫폼 ═══
  { x: -8, z: 2, w: 4, d: 4, h: 0.3 },
  { x: 8, z: 2, w: 4, d: 4, h: 0.3 },

  // ═══ Zone 1 & Zone 2 사이 중간 징검다리 ═══
  { x: -10, z: -40, w: 3, d: 3, h: 1.8 },
  { x: 10, z: -40, w: 3, d: 3, h: 2.0 },
];
...
export function getGroundHeight(x: number, z: number): number {
  ...
  return Math.max(0, maxH); // 바다에 빠지지 않게 0 최소
}
