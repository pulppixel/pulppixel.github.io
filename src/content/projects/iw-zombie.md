...
보이저에서 맡은 첫 프로젝트로, 일본 출시를 목표로 한 팀 서바이벌 게임입니다. 팀 내 최초로 Tencent IM SDK 기반 통신 환경을 구축했고, 이때의 도입 경험이 이후 REIW와 ETERNA의 채팅 아키텍처를 고도화하는 기반이 되었습니다.
...
- 약 1개월에 걸친 서브모듈 병합 작업을 팀과 함께 완료
