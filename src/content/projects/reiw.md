...
IW Zombie에서 팀 최초로 도입했던 Tencent IM 채팅을, 약 40명 규모의 메타버스 프로젝트 REIW로 가져와야 했습니다. 그대로 옮겨 쓸 수는 없었습니다. World/Whisper/Current/Guild/Party/System으로 채널 구조가 훨씬 복잡해졌고, 음성 메시지 송수신과 좋아요 표기 동기화처럼 이전에는 없던 기능이 요구됐으며, 첫 도입 당시 일정에 맞춰 붙였던 구조의 부채도 남아 있었습니다. 이식이 아니라 재설계가 필요하다고 판단했습니다.
