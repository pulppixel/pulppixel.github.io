...
전환을 설득한 사람이 결과도 증명해야 했습니다. Flutter도 Web3도 처음인 상태에서 1인 출시 전담으로 완주해야 하는 조건이었습니다. 키 파생과 트랜잭션 같은 Web3 도메인 자체가 낯설었고, 실수가 용납되지 않는 지갑 보안 설계와 암호화폐 앱 특유의 스토어 심사·출시 절차도 하나씩 익혀가며 넘어야 했습니다.
